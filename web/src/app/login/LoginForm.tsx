  ...
  return (
    <main style={{ minHeight: "100dvh", display: "grid", placeItems: "center" }}>
      <div style={{ width: "100%", maxWidth: 440, padding: 24, borderRadius: 12, border: "1px solid #e5e7eb" }}>
        ...
        <p style={{ color: "#6b7280", marginBottom: 16 }}>Entrez votre e-mail pour recevoir un lien magique.</p>
        ...
        {sent ? (
          ...
          <form onSubmit={onSubmit}>
            <label htmlFor="email" style={{ display: "block", fontSize: 14, marginBottom: 6 }}>Adresse e-mail</label>
